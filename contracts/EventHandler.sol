...
contract EventHandler {
    ...
    event Bought(address buyer, address tokenAddress, uint256 amountToken, uint256 lastTokenPrice, uint256 amountETH, uint256 contractTokenBalance, uint256 contractETHBalance, uint256 userTokenBalance, uint256 timestamp);
    event Sold(address seller, address tokenAddress, uint256 amountToken, uint256 lastTokenPrice, uint256 amountETH, uint256 contractTokenBalance, uint256 contractETHBalance, uint256 userTokenBalance, uint256 timestamp);
    ...
    function emitBuyEvent(address buyer, address tokenAddress, uint256 amountToken, uint256 lastTokenPrice, uint256 amountETH, uint256 contractTokenBalance, uint256 contractETHBalance, uint256 userTokenBalance) external {
        ...
        emit Bought(buyer, tokenAddress, amountToken, lastTokenPrice, amountETH, contractTokenBalance, contractETHBalance, userTokenBalance, block.timestamp);
    }
    ...
    function emitSellEvent(address seller, address tokenAddress, uint256 amountToken, uint256 lastTokenPrice, uint256 amountETH, uint256 contractTokenBalance, uint256 contractETHBalance, uint256 userTokenBalance) external {
        ...
        emit Sold(seller, tokenAddress, amountToken, lastTokenPrice, amountETH, contractTokenBalance, contractETHBalance, userTokenBalance, block.timestamp);
    }
